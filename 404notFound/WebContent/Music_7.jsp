...
<%
	...
	session.setAttribute("Q6", request.getParameter("Q"));
	session.setAttribute("A6", request.getParameter("A"));
	  ...
	  <div class="card mt-4 mb-4" style="width: 70%">
		<img src="profile.webp" class="card-img-top" alt="..." height="350px">
		  <div class="card-body radio-toolbar">
			<p class="card-text"><span class="badge badge-pill badge-warning"> Question 7</span></p>
			<p class="card-text"><%= ques%></p>
			  <form action="Music_8.jsp" method="post">
