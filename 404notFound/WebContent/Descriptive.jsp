...
<%
	...
	if(session.getAttribute("desc_date") == null){
		response.sendRedirect("Faculty_Portal");
	}
%>
...
<html lang="en">
	...
	<title>404notFound | Create-Descriptive</title>
    ...
    <body>
        ...
        <header>
          ...
          <nav class="navbar navbar-expand-lg navbar-dark fixed-top scrolling-navbar mb-5">
            <div class="container">
              <a class="navbar-brand" href="Faculty_Portal"><strong>404notFound</strong></a>
              ...
              <div class="container">
                ...
                <div class="row">
                  ...
                  <div class="col-md-12 mt-5 mb-4 white-text text-center">
                    ...
                    <h1 class="h1-reponsive white-text text-uppercase font-weight-bold mb-0 pt-md-5 pt-5 wow fadeInDown" data-wow-delay="0.3s"><strong>ADD DESCRIPTIVE QUESTIONS</strong></h1>
        ...
        <!-- Editable table -->
<div class="card">
  <h3 class="card-header text-center font-weight-bold text-uppercase py-4">CREATE DESCRIPTIVE PAPER</h3>
  <center><div class="test mt-4">
  	<!-- Default form login -->
		<form class="text-center border border-light p-3" action="Add_Desc_Ques" method="post">
		    <!-- Email -->
		    <input type="text" id="defaultLoginFormEmail" class="form-control mb-4" placeholder="Enter Question" name="question" required="required">
		    <!-- Sign in button -->
		    <button class="btn btn-info btn-block my-4" type="submit">ADD QUESTION</button>
		    <a class="btn btn-success btn-block my-4" href="Faculty_Login">CREATE TEST</a>
		</form>
  ...
  <div class="card-body">
    <div id="table" class="table-editable">
      ...
      <table class="table table-bordered table-responsive-md table-striped text-center">
    	...
    	ResultSet rs = null;
    	try{
    		String sql = "select * from THEORY_TEST";
    		Class.forName("com.mysql.cj.jdbc.Driver");
    		con = DriverManager.getConnection(DB_Details.getURL(), DB_Details.getUsername(), DB_Details.getPassword());
    		stmt = con.prepareStatement(sql);
    		rs = stmt.executeQuery();
    		while(rs.next()){
    			String sno = rs.getInt("SNO") + "";
    			String question = rs.getString("QUESTION_STATEMENT");
    			String subject = rs.getString("SUBJECT_NAME");
    			%>
    				<tr>
    					<form action="Remove_Faculty" method="post">
			            <td class="pt-3-half" contenteditable="true"><%=sno %>
			            </td>
			            <td class="pt-3-half" contenteditable="true"><%=subject %>
			            <input type="hidden" name="hidden_subject" value="<%=subject%>">
			            </td>
			            <td class="pt-3-half" contenteditable="true"><%=question %>
			            <input type="hidden" name="hidden_question" value="<%=question%>">
			            </td>
			            <td>
