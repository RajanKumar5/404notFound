              ...
              <div class="container">
                ...
                <div class="row">
                  ...
                  <div class="col-md-12 mt-5 mb-4 white-text text-center">
                    ...
                    <a class="btn btn-outline-white wow fadeInDown" data-wow-delay="0.4s" href="Faculty_Login">FACULTY LOGIN</a>
                    <a class="btn btn-outline-white wow fadeInDown" data-wow-delay="0.4s" href="Admin_Login">ADMIN LOGIN</a>
                  </div>
                  <!--Grid column-->
                </div>
                <!--Grid row-->
