...
<html lang="en">
    ...
    <body>
        ...
        <header>
          ...
          <!-- Navbar -->
          <!-- Full Page Intro -->
          <div class="view" style="background-image: url('https://images.unsplash.com/photo-1434030216411-0b793f4b4173?ixid=MXwxMjA3fDB8MHxzZWFyY2h8Mnx8ZXhhbXxlbnwwfHwwfA%3D%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=600&q=60'); background-repeat: no-repeat; background-size: cover; background-position: center center;">
              ...
              <div class="container">
                ...
                <div class="row">
                  ...
                  <div class="col-md-12 mt-5 mb-4 white-text text-center">
                    ...
                    <h1 class="h1-reponsive white-text text-uppercase font-weight-bold mb-0 pt-md-5 pt-5 wow fadeInDown" data-wow-delay="0.3s"><strong>ONLINE EXAMINATION PORTAL</strong></h1>
                    <hr class="hr-light my-4 wow fadeInDown" data-wow-delay="0.4s">
                    <h5 class="text-uppercase mb-4 white-text wow fadeInDown" data-wow-delay="0.4s"><strong>404notFound</strong></h5>
                    <h5 class="text-uppercase mb-4 white-text wow fadeInDown" data-wow-delay="0.4s"><strong>YOU ARE ABOUT TO START THE EXAM. 
                    ONCE STARTED YOU CANNOT LEAVE THE EXAM UNTIL YOU ATTEMPT ALL THE QUESTIONS. ALSO, YOU CANNOT REVERT BACK TO PREVIOUS QUESTIONS, SO ANSWER CAREFULLY. GOOD LUCK FOR YOUR EXAM.</strong></h5>
                    <button onclick="popupform()">
                    <a class="btn btn-outline-white wow fadeInDown" data-wow-delay="0.4s" href="Exam.jsp">START THE EXAM</a>
        ...
        function popupform() {
        window.open('Exam.jsp', '_blank', 'toolbar=no,scrollbars=no,location=yes,resizable=yes,addressbar=yes');
            }
        </script>
        </header>
        <!-- Main navigation -->
